...
def run_game():
    choice = input('Thank you for accessing the Super Hero database. Use one of the following keywords to interact with our database: CREATE, UPDATE, DISPATCH, RELATIONS, LEARN, CONNECTIONS, LIST, HELP, QUIT.\nHint - type HELP if it is your first time here: ').upper()
    if choice == 'HELP':
